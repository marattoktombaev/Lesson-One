...
funcTwo (List result) {  
  ...
  if (first == last)
  {print ('Ваше число $first, потрачено вопросов $r');} 
...
if (r == 10)
{print('вы не смогли разгадать число с десяти попыток. Машина загадала число $d');}
...
if (e == d)
{print('Вы разгадали число с $r - попытки.');}
